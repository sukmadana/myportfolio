...
<script setup lang="ts">
    ...
    onMounted(() => {
        $gsap.from('.title',{y:'100%', duration: 1, stagger: {grid: 'auto', amount: 0.1}})
        $gsap.from('.text',{y:'100%', duration: 1,delay: 0.5 })
        $gsap.from('.button-wrapper',{opacity: 0, duration: 0.6,delay: 1 })
    });
</script>